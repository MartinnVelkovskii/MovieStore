        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MovieProduction = table.Column<string>(nullable: true),
                    MovieCategory = table.Column<string>(nullable: true),
                    MovieType = table.Column<string>(nullable: true),
                    MovieDimensions = table.Column<string>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Productions_Productions_ProductionId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Price = table.Column<double>(nullable: false),
                    Discound = table.Column<double>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProducerName = table.Column<string>(maxLength: 350, nullable: true),
                    ProducerId = table.Column<int>(nullable: false),
                    YearofIssue = table.Column<DateTime>(nullable: false),
                    LengthOfMovie = table.Column<int>(nullable: false),
                    ProductionName = table.Column<string>(maxLength: 350, nullable: true),
                    ...
                    CategoryId = table.Column<int>(nullable: true),
                    Price = table.Column<double>(nullable: false),
                    MovieType = table.Column<string>(maxLength: 50, nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Productions_ProductionId",
                table: "Productions",
                column: "ProductionId");
        }
